...
leg.AddEntry(graphs['xsec13'],'13 TeV #tilde{g}#tilde{g} Cross-section (NLO+NLL)','f')
...
lat.DrawLatex(855,12.5,'#scale[0.5]{#tilde{g}-#tilde{g} production, #tilde{g}#rightarrow 6q}')
